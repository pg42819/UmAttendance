...
public class LessonsRecyclerAdapter extends RecyclerView.Adapter<LessonsRecyclerAdapter.ViewHolder>
{
	...
	public static class ViewHolder extends RecyclerView.ViewHolder
	{
		...
		public ViewHolder(View view) {
			...
			textView = (TextView) view.findViewById(R.id.lessonTextView);
		}
	 ...
	 *
	 * @param courses Course[] containing the data to populate views to be used
	 * by RecyclerView.
	 */
	public LessonsRecyclerAdapter(Course[] courses)
	{
	...
	public void onBindViewHolder(ViewHolder viewHolder, final int position) {
		...
		viewHolder.getTextView().setText(courses[position].getName());
	}
